...
class Corners:
    def __init__(self, left_down: bool, left_up: bool, right_down: bool, right_up: bool) -> None:
        self.left_down = left_down
        self.left_up = left_up
        self.right_down = right_down
        self.right_up = right_up

    def all_is_reached(self) -> bool:
        return (self.left_down and self.left_up) and (self.right_down and self.right_up)
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[next_x][next_y]:
                ...
                if next_position == self.corners[0]:
                    ...
                    next_state.corners.left_up = True
                elif next_position == self.corners[2]:
                    next_state.corners.right_down = True
                elif next_position == self.corners[3]:
                    next_state.corners.right_up = True
